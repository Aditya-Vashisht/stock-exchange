...
//Maintains the Sell order in the queue based on the comparator

public class ExchangeofStock {
    ...
    private PriorityQueue<SellOrder> sellOrderPriorityQueue = new PriorityQueue<>(new Comparator<SellOrder>() {
        ...
        public int compare(SellOrder o1, SellOrder o2) {
            // if same price, return the greater one.
    ...
    public PriorityQueue<SellOrder> getSellOrderPriorityQueue() {       //used to retrieve the selling order
