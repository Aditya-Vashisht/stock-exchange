...
import service.ImplementationOfStockExchange;
...
public class StockExchangeApplication {
    public static void main(String[] args) {
        ...
        StockExchangeService service = new ImplementationOfStockExchange();
...
//        getSellOrderFromFile(list);
    ...
    private static void getSellOrderFromFile(ArrayList<SellOrder> list) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (type.equals("buy")) {
                new BuyOrder(orderId, stock, price, quantity, time);
            }
            if (type.equals("sell")) {
                new SellOrder(orderId, stock, price, quantity, time);
            }
        }
    }
}